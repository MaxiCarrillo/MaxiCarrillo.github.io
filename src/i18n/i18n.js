        ...
        resources: {
            en: {
                translation: {
                    ...
                    'MPA Description':
                        "I develop the user interface of the application using ReactTS, leveraging libraries like React Query and Zustand. I collaborate with designers and backend developers to create reusable components and define the architecture of various modules. I prioritize code quality by avoiding technical debt, optimizing performance, and continuously refactoring to improve the project's maintainability.",
                    'Ministry of Health of Jujuy': 'Ministry of Health of Jujuy',
                    ...
                    'Birabar Description': 'Management web application designed specifically for a restobar.',
                    ...
                    'El Topo Description':
                        'El Topo is a frictionless social deduction web app designed for gatherings. It features instant browser-based gameplay with no downloads required, supporting both Real-Time Online Multiplayer and Local Pass-and-Play modes.',
            ...
            es: {
                translation: {
                    ...
                    'Birabar Description': 'Aplicación web de gestión diseñada específicamente para un restobar.',
                    'MoffySports Description':
                    ...
                    'El Topo Description':
                        'El Topo es una web app de deducción social diseñada para animar cualquier juntada. Ofrece una experiencia de juego instantánea sin descargas, con modos multijugador online en tiempo real y local en un solo dispositivo.',
